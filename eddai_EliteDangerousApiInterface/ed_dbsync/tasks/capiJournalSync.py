...
class CapiJournalSync(Task):
    ...
    max_retries = 3
    retry_backoff = 60 * 10  # 10 minuti
    retry_backoff_max = 60 * 30 # 30 minuti
    autoretry_for = (JournalPartialContentError,CapiClinetRequestError)
    ...
    def run(self, user_id: int, *args, **kwargs):
        ...
        try:
            ...
            journal_entries = client.connect(endpoint='journal',*args, **kwargs)
